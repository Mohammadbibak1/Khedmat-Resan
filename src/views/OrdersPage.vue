    ...
    <div v-if="!loading && orders.length > 0"  class="w-100 d-flex flex-column align-items-center row-gap-4 p-4" style="margin-top: 8rem">
      <div v-for="item in orders" :key="item.id" class="w-100 bg-white rounded-5 shadow-lite p-3">
        <div class="d-flex justify-content-between align-items-center pb-3">
          <div class="d-flex">
            <p class="font-4 font-bold">{{ item.service }}</p>
            <p class="font-4 font-bold mr-2">{{ item.order_number }}</p>
          </div>

          <button
            :style="{ backgroundColor: item.status_color }"
            class="w-40 button-status rounded-3 p-2"
          >
            {{ item.status_name }}
          </button>
        </div>
        ...
        <div
          ...
          style="border-top: #0ba6ab solid 3px; border-bottom: #0ba6ab solid 3px"
        >
          <div class="d-flex justify-content-start align-items-center column-gap-3">
            <img src="../assets/img/Order-loc.svg" alt="calender" class="icon-size-1" />
          ...
          <div class="d-flex justify-content-start align-items-center column-gap-3">
            <img src="../assets/img/calendar-order.svg" alt="calender" class="icon-size-1" />
            <p class="font-4 font-bold">آدرس سفارش :</p>
          ...
          <div class="d-flex justify-content-start align-items-center column-gap-3">
            <img src="../assets/img/order-price.svg" alt="calender" class="icon-size-1" />
          ...
          <div class="d-flex justify-content-start align-items-center column-gap-3">
            <img src="../assets/img/Order-Wallet.svg" alt="calender" class="icon-size-1" />
        ...
        <div class="w-100 d-flex justify-content-between align-items-center mt-3">
          ...
          <button
            ...
            class="w-35 button-Cancel p-3 text-white shadow-lite"
